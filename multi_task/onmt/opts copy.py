...
def model_opts(parser):
    ...
    group.add('--enc_sp_layers', '-enc_sp_layers', type=int, default=3,
              help='Number of sp layers in the encoder')
    group.add('--enc_nmt_layers', '-enc_nmt_layers', type=int, default=3,
              help='Number of nmt layers in the encoder')
...
def joint_preprocess_opts(parser):
  """ Pre-procesing options """
  # Data options
  group = parser.add_argument_group('Data')

  group.add('--nmt_train_src', '-nmt_train_src', required=True,
            help="Path to the nmt training source data")
  group.add('--nmt_train_tgt', '-nmt_train_tgt', required=True,
            help="Path to the nmt training target data")
  group.add('--nmt_valid_src', '-nmt_valid_src', required=True,
            help="Path to the nmt validation source data")
  group.add('--nmt_valid_tgt', '-nmt_valid_tgt', required=True,
            help="Path to the nmt validation target data")

  group.add('--sp_train_src', '-sp_train_src', required=True,
            help="Path to the sp training source data")
  group.add('--sp_train_tgt', '-sp_train_tgt', required=True,
            help="Path to the sp training target data")
  group.add('--sp_valid_src', '-sp_valid_src', required=True,
            help="Path to the sp validation source data")
  group.add('--sp_valid_tgt', '-sp_valid_tgt', required=True,
            help="Path to the sp validation target data")
  ...
  group.add('--sp_vocab_size', '-sp_vocab_size', type=int, default=50000,
            help="Size of the target vocabulary")
  ...
  group.add('--sp_words_min_frequency',
            '-sp_words_min_frequency', type=int, default=0)
...
def train_opts(parser):
    ...
    group.add('--nmt_batch_size', '-nmt_batch_size', type=int, default=64,
              help='Maximum batch size for training')
    group.add('--sp_batch_size', '-sp_batch_size', type=int, default=64,
              help='Maximum batch size for training')
    ...
    group.add('--nmt_valid_batch_size', '-nmt_valid_batch_size', type=int, default=32,
              help='Maximum batch size for nmt validation')
    group.add('--sp_valid_batch_size', '-sp_valid_batch_size', type=int, default=32,
              help='Maximum batch size for sp validation')
    group.add('--max_generator_batches', '-max_generator_batches',
              type=int, default=32,
              help="""Maximum batches of words in a sequence to run
                        the generator on in parallel. Higher is faster, but
                        uses more memory.""")
    group.add('--nmt_train_steps', '-nmt_train_steps', type=int, default=100000,
              help='Number of nmt training steps')
    group.add('--sp_train_steps', '-sp_train_steps', type=int, default=100000,
              help='Number of sp training steps')
    ...
    group.add('--truncated_decoder', '-truncated_decoder', type=int, default=0,
              help="""Truncated bptt (Truncated Backpropagation Through Time ).""")
    ...
    group.add('--sp_learning_rate', '-sp_learning_rate', type=float, default=1.0,
              help="""Starting learning rate.
                       Recommended settings: sgd = 1, adagrad = 0.1,
                       adadelta = 1, adam = 0.001""")
    ...
    group.add('--nmt_warmup_steps', '-nmt_warmup_steps', type=int, default=4000,
              help="""Number of warmup steps for custom decay.""")
    group.add('--sp_warmup_steps', '-sp_warmup_steps', type=int, default=4000,
              help="""Number of warmup steps for custom decay.""")
