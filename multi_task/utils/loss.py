...
def build_loss_compute(model, tgt_vocab, opt, train=True, task_type='task'):
  """
  ...
  compute = NMTLossCompute(criterion, loss_gen, task_type=task_type)
  compute.to(device)
...
class LossComputeBase(nn.Module):
    ...
    def __init__(self, criterion, generator, task_type):
...
class NMTLossCompute(LossComputeBase):
  ...
  def __init__(self, criterion, generator, normalization="sents", task_type='task'):
    super(NMTLossCompute, self).__init__(criterion, generator, task_type)
